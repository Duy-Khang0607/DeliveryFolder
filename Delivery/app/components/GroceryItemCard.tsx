...
const GroceyItemCard = ({ groceries }: GroceryItemCardProps) => {
  ...
  return (
    <motion.div className='bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-neutral-300 flex flex-col md:min-w-[150px]'
