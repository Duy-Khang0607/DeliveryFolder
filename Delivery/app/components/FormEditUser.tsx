...
const FormEditUser = ({ isEdit, title, description, setEdit, editItem, fetchUsers }: FormUserProps) => {
    ...
    return (
        ...
        >
            <motion.div
                className="relative min-w-xs md:max-w-2xl max-h-[70vh] overflow-y-auto md:min-h-[50vh] md:overflow-y-auto rounded-3xl bg-white shadow-2xl border border-gray-100 py-5 smooth-scroll"
