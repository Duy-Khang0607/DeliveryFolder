...
export function ToastProvider({ children }: { children: ReactNode }) {
    ...
    const showToast = (message: string | ReactNode, type: ToastType = "success") => {
                ...
                <AnimatePresence>
                    {toasts?.map((toast) => (
                        <motion.div
                            ...
                            className={`px-2 py-2 h-full rounded-xl shadow-lg flex flex-row items-center gap-2 w-fit shadow-white/50 backdrop-blur-sm border 
